...
const Form__UserTaskProcess: React.FC<any> = (props: any) => {
	const [formApi, setFormApi] = useState<any>();
	const [bVar3, set__bVar3] = useState<boolean>(false);
	const [comment, set__comment] = useState<string>('');
...
export default Form__UserTaskProcess;
