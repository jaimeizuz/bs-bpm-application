...
const Form__ServiceTaskProcess_validateCountries: React.FC<any> = (
	props: any
) => {
    ...
    */
	...
	return (
		<div className={'pf-c-form'}>
			...
			<FormGroup fieldId='uniforms-0004-0005'>
				<Checkbox
...
export default Form__ServiceTaskProcess_validateCountries;
