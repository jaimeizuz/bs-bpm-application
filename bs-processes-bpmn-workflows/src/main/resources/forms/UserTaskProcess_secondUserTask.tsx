...
const Form__UserTaskProcess_secondUserTask: React.FC<any> = (props: any) => {
    ...
    */
	...
	return (
		<div className={'pf-c-form'}>
			...
			<FormGroup
				fieldId={'uniforms-000a-0004'}
				label={'Svar 1'}
				isRequired={false}>
				<TextInput
					name={'svar1'}
					id={'uniforms-000a-0004'}
					isDisabled={true}
					placeholder={''}
					type={'text'}
					value={svar1}
...
export default Form__UserTaskProcess_secondUserTask;
