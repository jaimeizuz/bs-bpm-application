package es.santander.scib.gboboxaccount.servicetasks;
...
@ApplicationScoped
public class GboBoxAccountServiceTask {

    @Inject
    @RestClient
    EntitiesApi entitiesRestClient;

    Logger logger = Logger.getLogger(GboBoxAccountServiceTask.class);
