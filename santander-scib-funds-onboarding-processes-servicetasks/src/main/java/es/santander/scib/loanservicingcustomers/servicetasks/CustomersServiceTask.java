...
import es.santander.scib.loanservicingcustomers.rest.client.CustomersApi;

@ApplicationScoped
public class CustomersServiceTask {

    @Inject
    @RestClient
    CustomersApi customersRestClient;

    Logger logger = Logger.getLogger(CustomersServiceTask.class);
