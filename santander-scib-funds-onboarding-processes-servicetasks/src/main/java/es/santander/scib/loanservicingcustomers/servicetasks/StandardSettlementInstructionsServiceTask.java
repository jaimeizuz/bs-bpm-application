package es.santander.scib.loanservicingcustomers.servicetasks;
...
import es.santander.scib.loanservicingcustomers.rest.client.StandardSettlementInstructionsApi;

@ApplicationScoped
public class StandardSettlementInstructionsServiceTask {

    @Inject
    @RestClient
    StandardSettlementInstructionsApi standardSettlementInstructionsRestClient;

    Logger logger = Logger.getLogger(StandardSettlementInstructionsServiceTask.class);
